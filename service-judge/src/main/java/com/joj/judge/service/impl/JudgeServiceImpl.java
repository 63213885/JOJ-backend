...
public class JudgeServiceImpl implements JudgeService {
    ...
    private String type;
    // todo 工厂交给Spring管理，直接注入CodeSandBox接口，配置文件指定具体实现类

    String executeCode(Submission submission, Problem problem) {
        ...
        if (timeUsed > timeLimit) {
            ...
            return SubmissionStatusEnum.TIME_LIMIT_EXCEEDED.getValue();
        }
        if (memoryUsed > memoryLimit * 1024 * 1024) {
            ...
            return SubmissionStatusEnum.MEMORY_LIMIT_EXCEEDED.getValue();
        }
        if (outputList == null ||  outputList.size() != answerList.size()) {
            ...
            return SubmissionStatusEnum.WRONG_ANSWER.getValue();
        }
        ...
        return SubmissionStatusEnum.ACCEPTED.getValue();
    }
    ...
    public void doJudge(Long submissionId) {
        ...
        String result = executeCode(submission, problem);
