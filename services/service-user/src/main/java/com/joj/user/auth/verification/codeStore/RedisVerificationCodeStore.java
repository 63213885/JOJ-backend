package com.joj.user.auth.verification.codeStore;

/**
 * @author jzz
 * @github <a href="https://github.com/63213885">63213885</a>
 * @createtime 2026/4/9 17:03
 */
...
public class RedisVerificationCodeStore implements VerificationCodeStore {
    ...
    private static String buildKey(String scene, String identifier) {
        return "verification:code:" + scene + ":" + identifier;
    }
    ...
    public void saveCode(String scene, String identifier, String code, Duration ttl, int maxAttempts) {
        ...
        try {
            ...
            redisTemplate.expire(key, ttl); // todo: 如果设置失败，可能会导致过期时间不生效，需考虑事务或 Lua 脚本保证原子性
